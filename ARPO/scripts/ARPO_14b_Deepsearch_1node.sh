...
EXPERIMENT_NAME="ARPO_14B_Deepsearch_global_12_init_6_beam_2_random_0.5_arpo_0.2_entropy" # Modify experiment name
...
# ============================ Model Configuration ============================
# Actor model path
ACTOR_MODEL_PATH="<your_14B_model_path>" # Modify training model path
